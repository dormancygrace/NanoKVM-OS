const ru = {
  translation: {
    ...
    settings: {
      software: {
        title: "Программы",
        description: "Управление пакетами из настроенных репозиториев Alpine. Изменения используют ту же базу APK и сервисы, что и по SSH.",
        refresh: "Обновить индексы",
        upgrade: "Обновить всё",
        upgradeConfirm: "Обновить все установленные пакеты? Видео и управление могут ненадолго отключиться.",
        ...
        indexStale: "Индексы пакетов могут быть устаревшими (обновлены: {{updated}}). Обновите их перед установкой.",
        indexUnknown: "время неизвестно",
        install: "Установить",
        installed: "Установленные пакеты",
        remove: "Удалить",
        removeTitle: "Удалить {{package}}?",
        removeDescription: "APK выполнит удаление и изменения зависимостей в точности как показано ниже. Автоматического отката нет.",
        ...
        requestFailed: "Запрос к программам не выполнен. Проверьте подключение к устройству и повторите попытку."
      },
      updates: {
        apk: {
      ...
      appearance: {
        branding: {
          title: 'Брендирование',
          description:
            'Логотип страницы входа и вкладки браузера. Изменения применяются сразу и сохраняются на устройстве.',
          connection: 'Соединение (по умолчанию)',
          screen: 'Экран',
          custom: 'Свой логотип',
          upload: 'Загрузить логотип',
          remove: 'Удалить свой логотип',
          formats:
      ...
      network: {
        ...
        wifi: {
          ...
          preferredBandHint: 'Будет использован при следующем подключении Wi-Fi. Второй диапазон остаётся резервным.',
          scan: 'Обзор сетей',
