#!/usr/bin/env python3
"""Build the hardware encoder diagnostic with the selected Enhanced libraries."""
...
subprocess.run([cross+'g++', '-std=gnu++17', '-Os', '-Wall', '-Wextra', '-Werror',
    ...
    '-I'+str(mpi/'include'), str(repo/'firmware/probes/encoder-runtime.cpp'),
    '-L'+str(mmf), '-L'+str(mpi/'lib'), '-lkvm_mmf', '-lsys',
