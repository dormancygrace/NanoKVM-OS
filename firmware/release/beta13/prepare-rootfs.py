#!/usr/bin/env python3
"""Apply the beta-13 release delta to a mounted pristine beta-10 image."""
import argparse
import hashlib
import json
import os
...
for name in ('repo', 'output', 'server', 'web', 'capture', 'board-stage', 'boot'):
...
assert sha(a.server) == 'b61483658dc75ed5e36683d646166af5608e60d0f3cbf26d4a06e4d1db5ba57b'
...
version, sequence = '1.0.0-beta.13', 29
...
(root / 'usr/lib/os-release').write_text(
    ...
    'VERSION_ID="1.0.0-beta.13"\nPRETTY_NAME="NanoKVM OS v1.0.0 beta-13"\n')
(root / 'etc/issue').write_text('NanoKVM OS v1.0.0 beta-13\n')
...
manifest = {
    ...
    'inputs': {'base': 'pristine beta-10 seq23 image',
               ...
               'server_input': 'universal-server-v1, Lite ATX disabled',
