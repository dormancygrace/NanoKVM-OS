const th = {
  translation: {
    ...
    mouse: {
      ...
      inputAdapter: {
        title: 'อะแดปเตอร์อินพุต',
        auto: 'อัตโนมัติ',
        'pointer-lock': 'ล็อกตัวชี้',
        touchpad: 'ทัชแพด'
      },
      touchpadGuide: {
        title: 'คู่มือทัชแพด',
        scope: 'ใช้เมื่ออะแดปเตอร์อินพุตเป็นทัชแพดและโหมดเมาส์เป็นแบบสัมพัทธ์',
        swipeTitle: 'ปัดเพื่อเลื่อน',
        swipeDesc: 'ปัดภายในพื้นที่หน้าจอที่ใช้งานเพื่อเลื่อนตัวชี้ระยะไกล',
        tapTitle: 'แตะเพื่อคลิก',
        tapDesc: 'การแตะสั้น ๆ จะส่งคลิกซ้ายหนึ่งครั้ง',
        holdTitle: 'กดค้างเพื่อกดปุ่มซ้าย',
        holdDesc: 'แตะค้างและอยู่นิ่งประมาณ 1 วินาทีเพื่อกดปุ่มซ้ายของเมาส์ค้างไว้',
        dragTitle: 'เลื่อนหลังจากกดค้างเพื่อลาก',
        dragDesc: 'เมื่อการกดค้างทำงานแล้ว ให้เลื่อนนิ้วเพื่อลากโดยกดปุ่มซ้ายค้างไว้'
      },
      resetHid: 'รีเซ็ต HID',
      hidOnly: {
