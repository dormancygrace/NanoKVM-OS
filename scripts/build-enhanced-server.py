...
native_libraries = Path(os.environ['NANOKVM_NATIVE_LIBRARIES']).resolve() if os.environ.get('NANOKVM_NATIVE_LIBRARIES') else None
...
if native_libraries:
    inputs = {name: native_libraries/name for name in inputs}
