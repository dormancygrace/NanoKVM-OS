# Installing NanoKVM OS v2.0 b4

Download NanoKVM-OS-v2.0-b4.img.zip and SHA256SUMS from the release. Verify the
...
is separate. See RELEASE-v2.0-b4.md and UPDATES.md for current release details.
