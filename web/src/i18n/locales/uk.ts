const uk = {
  translation: {
    ...
    mouse: {
      ...
      inputAdapter: {
        title: 'Адаптер введення',
        auto: 'Автоматично',
        'pointer-lock': 'Блокування вказівника',
        touchpad: 'Сенсорна панель'
      },
      touchpadGuide: {
        title: 'Посібник із тачпада',
        scope: 'Застосовується, коли адаптер вводу вибрано як тачпад, а режим миші є відносним.',
        swipeTitle: 'Проведіть, щоб перемістити',
        swipeDesc: 'Проведіть в активній області екрана, щоб перемістити віддалений вказівник.',
        tapTitle: 'Торкніться, щоб клацнути',
        tapDesc: 'Короткий дотик надсилає один клік лівою кнопкою.',
        holdTitle: 'Утримуйте для натискання лівої кнопки',
        holdDesc:
          'Торкніться й утримуйте палець нерухомо приблизно 1 секунду, щоб ліва кнопка миші залишалась натиснутою.',
        dragTitle: 'Рухайте після утримання, щоб перетягнути',
        dragDesc:
          'Коли утримання активне, рухайте палець, щоб перетягувати з натиснутою лівою кнопкою.'
      },
    ...
    settings: {
      ...
      network: {
        ...
        ethernet: {
          ...
          staticDescription:
            'Налаштування застосовуються негайно й зберігаються після перезавантаження',
          ipAddress: 'IP-адреса',
          ...
          savedDhcp:
            'DHCP увімкнено. Повторно підключіться, використовуючи адресу, призначену маршрутизатором.',
