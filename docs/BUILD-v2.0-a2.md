...
The accepted component revisions are app 2.0_alpha2-r1, base 2.0_alpha2-r2,
kernel/modules 2.0_alpha2-r0 and release 2.0_alpha2-r1. Build a clean Alpine
