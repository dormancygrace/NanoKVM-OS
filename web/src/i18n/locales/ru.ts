const ru = {
  translation: {
    audio: {
      receiving: 'Аудиопакеты поступают',
      waiting: 'Ожидание звука',
      errors: {
        connection: 'Соединение звука потеряно. Включите прослушивание снова.',
        timeout: 'Не удалось подключить звук. Проверьте сеть и повторите.',
        playback: 'Браузер не запустил звук. Нажмите прослушивание снова.',
        signaling: 'Не удалось согласовать звук. Обновите страницу и повторите.',
        capture: 'Захват USB-звука остановлен. Включите прослушивание снова.',
        session: 'Сеанс истёк. Войдите снова.',
        closed: 'Соединение звука закрыто. Включите прослушивание снова.'
      },
      title: 'USB-звук',
      listen: 'Слушать',
      volume: 'Громкость',
    ...
    inputConnection: {
      idle: 'Канал управления не подключён',
      connecting: 'Подключение управления',
      connected: 'Канал управления подключён',
      reconnecting: 'Связь управления потеряна. Переподключение…',
      disconnected: 'Управление недоступно. Переподключение… Видео может продолжать работать.'
    },

    sessionControl: {
      active: 'Этот сеанс браузера управляет клавиатурой и мышью',
      locked: 'Только просмотр: клавиатурой и мышью управляет другой сеанс',
      take: 'Получить управление',
      release: 'Заблокировать этот сеанс'
    },
    ...
    screenshot: {
      take: 'Сделать снимок экрана',
      saving: 'Сохранение снимка…',
      saved: 'Снимок сохранён ({{width}}×{{height}})',
      captureDisabled: 'Включите захват, чтобы сделать снимок',
      noVideo: 'Дождитесь видеокадра, чтобы сделать снимок',
      failed: 'Не удалось сохранить снимок'
    },
    vpn: {
      ...
      openvpnInstallDescription: 'Установите OpenVPN по запросу. Существующие профили сохранятся.',
      openvpnInstall: 'Установить OpenVPN',
      openvpnInstalled: 'OpenVPN установлен',
      openvpnUninstall: 'Удалить OpenVPN',
      openvpnUninstallWarning:
        'OpenVPN будет остановлен и удалён. Существующие профили и настройки останутся на устройстве.',
      confirm: 'Да',
      cancel: 'Нет',
      openvpnNote:
    ...
    videoSettings: {
      preferFhd60: 'Предпочитать 1920 × 1080 · 60 Гц',
      preferHd60: 'Предпочитать 1280 × 720 · 60 Гц',
      cubeMonitorHint:
        'Cube/Lite: EDID будет записан и проверен. Для применения отключите все источники питания и подключите их снова. Программной перезагрузки недостаточно. Автоматический режим использует профиль 1080p/60.',
      powerCycleTitle: 'Потребуется физическое отключение питания',
      powerCycleConfirm:
        'Продолжайте, только если после записи сможете физически отключить все источники питания NanoKVM. До этого видео может быть недоступно. Программная перезагрузка не применяет это изменение.',
      powerCycleWrite: 'Записать EDID',
      powerCycleCancel: 'Отмена',
      powerCycleWritten:
        'EDID записан и проверен. Отключите и подключите питание NanoKVM для применения.',
      powerCyclePending: 'После записи EDID требуется отключить питание',
      powerCyclePendingHint:
        'Была предпринята запись EDID. Отключите все источники питания и подключите NanoKVM снова. Напоминание сохраняется после программной перезагрузки; уберите его только после физического отключения питания.',
      powerCycleAck: 'Питание уже отключено и подключено',
      powerCycleAckConfirm:
        'Подтвердите, что физически отключили все источники питания и подключили NanoKVM снова. Это только уберёт напоминание и не перезагрузит устройство.',

      directPlayback: 'Отображение Direct',
      directSmooth: 'Плавное изображение',
      directImmediate: 'Минимальная задержка',
      directSmoothHint:
        'Адаптивный буфер сглаживает неравномерную доставку кадров, добавляя небольшую задержку.',
      directImmediateHint:
        'Кадры отображаются сразу после декодирования. Неравномерная доставка может вызывать рывки.',
      directPlaybackLocal: 'Сохраняется в этом браузере. Для H.264 и H.265 Direct.',
      ...
      portrait: 'Портретный монитор',
      portraitProfile: 'Портретный профиль',
      portraitHDProfile: '720 × 1280 · 120 Гц',
      portraitDefaultProfile: '1080 × 1920 · 75 Гц',
      portraitAVCProfile: '1296 × 2304 · 50 Гц (H.264)',
      portraitMaximumProfile: '1440 × 2560 · 40 Гц (H.265)',
      portraitMaximumHint:
        'Максимальный профиль требует H.265 Direct, до 40 кадров/с. При его выборе этот режим видео устанавливается автоматически.',
      portraitHint:
        'Используется выбранный портретный профиль монитора. Максимальный профиль 1440 × 2560 — около 3,7 Мп при 40 FPS. Выбранный альбомный профиль сохраняется и восстанавливается после отключения портретного режима.',
      portraitUnavailable: 'Портретный профиль монитора недоступен на этом устройстве.',
      automatic: 'Автоматический (рекомендуется)',
      preferFhd: 'Предпочитать 1920 × 1080 · 75 Гц',
      preferQhd: 'Предпочитать 2560 × 1440 · 50 Гц',
      preferHd: 'Предпочитать 1280 × 720 · 120 Гц',
      monitorHint:
      ...
      gopModeHint:
        'NormalP использует меньше видеопамяти. SmartP может уменьшить трафик на статичных сценах, но удерживает дополнительный фоновый опорный кадр. Сохранённый выбор вступит в силу после перезагрузки устройства.',
      gopModeRebootRequired: 'Режим GOP сохранён. Для применения перезагрузите устройство.',
      gopModePendingReboot:
        'Сохранённое изменение режима GOP H.265 ожидает перезагрузки устройства.',
      gopModePendingRebootHint: 'Активный режим: {{active}}. Выбранный режим: {{selected}}.',
      gopHint:
    ...
    image: {
      remote: {
        device: 'С SD-карты',
        browser: 'С этого компьютера',
        hint: 'Подключите ISO с этого компьютера как CD/DVD только для чтения. Передаются лишь запрошенные блоки. Оставьте эту вкладку открытой, пока используется образ.',
        select: 'Выберите файл ISO',
        connect: 'Подключить ISO',
        connecting: 'Подключение…',
        mounted: 'Подключён · Только чтение',
        read: 'прочитано',
        disconnect: 'Отключить ISO',
        readFailed: 'Не удалось прочитать выбранный ISO. Подключите файл заново.',
        connectFailed:
          'Не удалось подключить ISO. Проверьте соединение с устройством и повторите попытку.',
      ...
      forceEject: 'Извлечь принудительно',
      forceEjectDesc:
        'Удалённый хост всё ещё использует этот образ. Принудительное извлечение может прервать текущие операции чтения или записи. Продолжить?',
    ...
    settings: {
      software: {
        title: 'Программы',
        description:
          'Управление пакетами из настроенных репозиториев Alpine. Изменения используют ту же базу APK и сервисы, что и по SSH.',
        refresh: 'Обновить индексы',
        upgrade: 'Обновить всё',
        upgradeConfirm:
          'Обновить все установленные пакеты? Видео и управление могут ненадолго отключиться.',
        ...
        indexStale:
          'Индексы пакетов могут быть устаревшими (обновлены: {{updated}}). Обновите их перед установкой.',
        indexUnknown: 'время неизвестно',
        install: 'Установить',
        installed: 'Установленные пакеты',
        remove: 'Удалить',
        removeTitle: 'Удалить {{package}}?',
        removeDescription:
          'APK выполнит удаление и изменения зависимостей в точности как показано ниже. Автоматического отката нет.',
        started: 'Операция APK запущена',
        running: 'APK выполняет: {{action}} {{package}}',
        succeeded: 'Операция APK завершена',
        failed: 'Ошибка операции APK',
        requestFailed:
          'Запрос к программам не выполнен. Проверьте подключение к устройству и повторите попытку.'
      },
      updates: {
        apk: {
          title: 'Обновления пакетов',
          description:
            'Обновление установленных пакетов из настроенных репозиториев с сохранением настроек. Службы перезапускаются автоматически; после обновления ядра нужна перезагрузка.',
          kernel: 'Работающее ядро',
          check: 'Проверить обновления',
          install: 'Установить обновления',
          confirm: 'Установить эти обновления? Видео и управление могут ненадолго отключиться.',
          installed: 'Обновления пакетов установлены',
          current: 'Все установленные пакеты актуальны',
          failed: 'Ошибка обновления пакетов',
          rebootRequired:
            'Обновления установлены. Перезагрузите устройство для применения нового ядра или системных компонентов.',
          reboot: 'Перезагрузить устройство',
          rebootConfirm: 'Перезагрузить устройство сейчас?',
        ...
        alpineOptions: 'Параметры образа',
        ...
        alpineStage: 'Скачать образ',
        alpineInstall: 'Переустановить и перезапустить',
        alpineConfirm:
          'Отформатировать системный раздел, установить этот образ Alpine и перезапустить устройство?',
        alpineBuilderMissing:
          'Сборщик персональных образов не настроен. Укажите alpine.builderURL или используйте проверенный recovery bundle вручную.',
        check: 'Проверить обновления',
        ...
        compatibility:
          'Совместимые подписанные пакеты NanoKVM OS обновляют приложение и системные компоненты, сохраняя настройки. Пакеты с ядром заменяют ядро и соответствующие модули после перезагрузки. Автоматического отката ядра нет: при сбое загрузки потребуется заново прошить SD-карту. Архивы оригинальной NanoKVM отклоняются.',
        requestFailed:
      ...
      memory: {
        videoMode: "Выделение видеопамяти",
        videoModeDescription: "Оба режима выделяют 64 MiB для видео. CMA позволяет Linux использовать свободные страницы; Fixed резервирует весь объём только для видео. Изменение применяется после перезагрузки.",
        videoCma: "CMA — 64 MiB (по умолчанию)",
        videoFixed: "Fixed — 64 MiB",
        videoFixedShort: "Fixed",
        videoActive: "Сейчас используется",
        videoUnknown: "Неизвестно",
        videoModeUnavailable: "Для переключения обновите пакет ядра.",
        videoReboot: "Перезагрузите устройство для применения выбранного режима видеопамяти.",
      ...
      system: {
        ...
        diagnostics: {
          title: 'Диагностика',
          description:
            'Статус для поддержки только на чтение. Сбор кэшируется и ничего не меняет на устройстве.',
          refresh: 'Обновить',
          download: 'Скачать отчёт',
          loadError: 'Не удалось собрать диагностику',
          downloadError: 'Не удалось скачать отчёт диагностики',
          collected: 'Собрано: {{time}}',
          versions: 'Версии и совместимость',
          application: 'Приложение',
          image: 'Образ',
          alpine: 'Alpine',
          kernel: 'Запущенное ядро',
          systemBase: 'База системы',
          modules: 'Модули ядра',
          boot: 'Компоненты загрузки',
          video: 'HDMI и видеозахват',
          capture: 'Захват',
          edid: 'Программирование EDID',
          operationFailed:
            'Последняя операция завершилась ошибкой; исходный лог намеренно не включён в отчёт.',
          ...
          states: {
            ...
            'power-cycle-pending': 'нужно физически отключить питание',
            'pending-reboot': 'ожидается перезагрузка'
          }
        },
        services: 'Службы',
        ...
        ssh: {
          ...
          tip: 'SSH включается только после задания нового пароля Linux-пользователя root.',
          passwordTitle: 'Пароль root для SSH',
          passwordDescription:
            'Перед включением SSH задайте надёжный пароль Linux-пользователя root. Он используется для входа по SSH.',
          password: 'Новый пароль root',
          confirmation: 'Подтвердите пароль root',
          rootForbidden: 'Пароль не может быть «root».',
          enable: 'Задать пароль и включить SSH',
          failed: 'Не удалось задать пароль root или включить SSH.'
        }
      },
      title: 'Настройки',
      back: 'Назад',
      ...
      about: {
        ...
        credits: {
          ...
          resume: 'Продолжить',
          close: 'Закрыть',
          madePossibleBy: 'Этот проект стал возможен благодаря',
          projectLead:
            'Идея, архитектура и разработка NanoKVM OS, системная интеграция, испытания на устройствах и подготовка релизов.',
          wenjie:
            'Сопровождение исходного приложения NanoKVM; исправления Direct H.264, запуска Tailscale и сети; интеграция UI и локализаций.',
          z2zGuGu:
            'Нативные компоненты KVM, MMF и vision; инструменты сборки, watchdog, утилиты EDID и USB PID/VID; основы кастомизации устройства.',
          alexanderGerReich:
            'Логика приложения, обновлений и загрузок; улучшения HID, вставки и виртуальной клавиатуры; поддержка немецкого и английского интерфейса.',
          andrewMoryakov:
            'Интеграция клиента и настроек NetBird, безопасный жизненный цикл и восстановление VPN, проверка артефактов и регрессионные CI-тесты.',
          watermeko:
            'Проверяемые и отменяемые загрузки и OTA, низколатентный и zero-copy H.264, настраиваемые области ввода и исправления мыши.',
          scpcom:
            'Надёжность виртуальных носителей, загрузок и хранилища; блокировки HID; исправления hostname и сети; очистка нативного MMF.',
          lingkongSky:
            'Mouse Jiggler, редактирование hostname и заголовка страницы, имена Wake-on-LAN, подтверждения питания и управление swap.',
          polyzium:
            'Русская локализация, универсальная 104-клавишная виртуальная клавиатура, режим вписывания в окно и исправления переводов UI.',
          yuryPekishev:
            'Русская раскладка виртуальной клавиатуры и преобразование русского текста в английские клавиши при вставке.',
          thomasPressnell:
            'Сохраняемое включение и отключение HDMI и разделение управления USB gadget, подключением data-раздела и виртуальными носителями.',
          s33g: 'Брендинг и тексты экрана входа, подсказки панели, локализуемые ошибки и mock-окружение для разработки без устройства.',
          gxcreator:
            'Подробные сообщения о проблемах и постоянная обратная связь, выявлявшие регрессии и напрямую влиявшие на исправления.',
          yuziCo:
            'Подавление дубликатов MJPEG и backpressure захвата, а также решения broadcast acquisition и DHCP option 121, адаптированные из IronKVM.',
          sipeed: 'Оригинальная аппаратная платформа NanoKVM и основа исходного приложения.',
          silicon: 'Медиаплатформа SG2002, основы SDK и низкоуровневая поддержка оборудования.',
          systemStack:
            'Операционная система, инфраструктура сборки, управление пакетами и множество исправлений upstream.',
          appStack:
            'Приложение, веб-интерфейс, защищённый транспорт и компоненты передачи медиаданных в реальном времени.',
          projects:
            'Идеи, накопленный опыт, работа над совместимостью и вдохновение сообщества открытых KVM-проектов.',
          contributorsTitle: 'Участники open-source сообщества',
          contributors:
            'Код, переводы, тестирование, сообщения об ошибках, ревью, документация и терпеливая обратная связь.',
          closing: 'Спасибо всем, кто сделал NanoKVM OS возможной.'
        },
      ...
      appearance: {
        branding: {
          title: 'Брендирование',
          description:
            'Логотип страницы входа и favicon настраиваются независимо. Встроенные изображения всегда доступны для возврата.',
          logoTitle: 'Логотип страницы входа',
          logoDescription: 'Основной логотип над формой входа.',
          logoPreview: 'Предпросмотр логотипа страницы входа',
          logoUpload: 'Загрузить логотип',
          faviconTitle: 'Favicon',
          faviconDescription: 'Маленький значок на вкладке браузера.',
          faviconPreview: 'Предпросмотр favicon',
          faviconUpload: 'Загрузить favicon',
          defaultActive: 'Встроенное изображение',
          customActive: 'Своё изображение',
          restoreDefault: 'Восстановить встроенное',
          formats:
            'PNG или JPEG, до 2 МиБ и 1024 × 1024 пикселей. Лучше квадратный PNG с прозрачным фоном.',
          failed: 'Не удалось сохранить брендирование.'
        },
        buttonColor: {
          title: 'Цвет кнопок',
          description: 'Выберите акцентный цвет основных кнопок во всём интерфейсе.',
          accentTitle: 'Основные кнопки',
          accentDescription: 'Цвета наведения и нажатия создаются автоматически.',
          preview: 'Пример кнопки',
          inputLabel: 'Цвет кнопок в шестнадцатеричном формате',
          defaultActive: 'Встроенный зелёный логотипа (#45E9A0)',
          customActive: 'Свой цвет',
          save: 'Применить',
          restoreDefault: 'Восстановить встроенный',
          failed: 'Не удалось сохранить цвет кнопок.'
        },
        bannerStyle: {
          title: 'SSH-баннер',
      ...
      device: {
        ...
        oled: {
          failed: 'Не удалось обновить настройки OLED',
          '-1': 'Экран выключен',
          title: 'OLED экран',
      ...
      usb: {
        ...
        empty: 'Все USB-функции будут отключены от подключённого компьютера.',
        ...
        devices: {
          ...
          network: {
            ...
            description: 'Сетевой адаптер NCM на управляемом хосте'
          },
          disk: {
          ...
          audio: {
            title: 'USB-звук',
            description: 'Стереовыход звука подключённого компьютера (48 кГц, 16 бит)'
          },
          serial: {
      ...
      network: {
        ...
        general: 'Общее',
        gateway: {
          title: 'Предпочтительный шлюз',
          description:
            'Когда шлюз в Интернет есть и у Ethernet, и у Wi‑Fi, выберите подключение NanoKVM по умолчанию.',
          auto: 'Автоматически',
          none: 'Подключите Ethernet или Wi‑Fi, чтобы выбрать предпочтительный шлюз.',
          metric: 'приоритет маршрута {{value}}',
          loadFailed: 'Не удалось прочитать маршруты шлюза.',
        ...
        wifi: {
          ...
          band24: '2,4 ГГц',
          band5: '5 ГГц',
          preferredBand: 'Предпочтительный диапазон',
          preferredBandHint:
            'Будет использован при следующем подключении Wi-Fi. Второй диапазон остаётся резервным.',
          scan: 'Обзор сетей',
          scanFailed: 'Не удалось найти сети. Повторите попытку.',
          availableNetworks: 'Доступные сети',
          bandsUnavailable: 'Не удалось определить диапазоны адаптера.',
          noNetworks: 'В этом диапазоне сети не найдены.',
          manual: 'Подключиться вручную',
          hidden: 'Скрытая сеть',
          security: 'Защита',
          open: 'Открытая сеть',
          unsupported: 'Неподдерживаемая защита',
          reconnect: 'Переподключиться',
          applying: 'Применение… Связь с устройством может временно прерваться.',
          operationFailed: 'Не удалось применить настройки Wi-Fi. Повторите попытку.',
          statusFailed: 'Не удалось получить состояние Wi-Fi.',
          connectionTimeout:
            'Подключение не подтверждено. Проверьте сеть и подключитесь к устройству заново, если его адрес изменился.',
          passwordHint: '8–63 байта (для латиницы — от 8 символов).',
        ...
        ethernet: {
          ...
          enable: 'Ethernet',
          disabled: 'Отключён',
          interfaceDown: 'Включён в настройках · интерфейс сейчас опущен',
          linkUp: 'Включён · кабель подключён',
          noCable: 'Включён · кабель не подключён',
          disconnectWarning:
            'После сохранения соединения через Ethernet сразу прервутся. Убедитесь, что доступен другой способ управления.',
          dhcp: 'DHCP',
          static: 'Статический',
          ipv4: 'Настройка IPv4',
          ...
          vlan: 'VLAN',
          vlanDescription: 'Применить выбранный DHCP или статический IPv4 к eth0.<ID>',
          vlanWarning:
            'Смена VLAN может прервать соединение. Убедитесь, что порт коммутатора пропускает выбранный тегированный VLAN.',
          vlanId: 'VLAN ID',
          invalidVlan: 'VLAN ID должен быть от 1 до 4094',
      ...
      tailscale: {
        ...
        installing: 'Установка Tailscale',
        failed: 'Не удалось установить',
        retry: 'Повторите установку.',
      ...
      netbird: {
        ...
        installDescription: 'Установите NetBird по запросу. Существующие настройки сохранятся.',
        install: 'Установить NetBird',
        installing: 'Установка NetBird',
        ...
        uninstallWarning:
          'Если вы подключены через NetBird, это оборвёт соединение. Настройки устройства сохранятся.',
        version: 'Версия',
