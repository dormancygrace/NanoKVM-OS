...
printf '3145728\n' > "$SIZE_FILE"
run_create
assert_line '-s /dev/testdisk unit s mkpart primary ntfs 3180544s 100%' "$PARTED_LOG"
...
printf '15967232\n' > "$SIZE_FILE"
run_create
assert_line '-s /dev/testdisk unit s mkpart primary ntfs 16001024s 100%' "$PARTED_LOG"
...
printf '2048\n' > "$SIZE_FILE"
run_create
assert_line '-s /dev/testdisk unit s mkpart primary ntfs 4096s 100%' "$PARTED_LOG"
