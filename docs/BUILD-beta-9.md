...
See [the release notes](RELEASE-beta-9.md) for the packaged changes and supported update path. Build and package checks passed; sequence 22 itself was not flashed or capture-tested during its assembly.
