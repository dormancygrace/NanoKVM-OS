...
assert manifest['kernel']=='7.2.4-nanokvm-enhanced'
...
zram=root/'usr/lib/modules/7.2.4-nanokvm-enhanced/kernel/drivers/block/zram/zram.ko'
...
ovpn=root/'usr/lib/modules/7.2.4-nanokvm-enhanced/kernel/drivers/net/ovpn/ovpn.ko'
...
if manifest.get('beta_candidate'):
    for name in ('sg2002_aes_probe', 'cryptodev', 'aic8800_bsp', 'aic8800_fdrv', '8733bs'):
        path = root/('usr/lib/modules/7.2.4-nanokvm-enhanced/extra/'+name+'.ko')
