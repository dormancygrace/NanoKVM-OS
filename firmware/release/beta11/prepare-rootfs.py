#!/usr/bin/env python3
"""Apply the beta-11 release delta to a mounted pristine beta-10 image."""
import argparse
import hashlib
import json
import os
...
version, sequence = '1.0.0-beta.11', 27
...
(root / 'usr/lib/os-release').write_text(
    ...
    'VERSION_ID="1.0.0-beta.11"\nPRETTY_NAME="NanoKVM OS v1.0.0 beta-11"\n')
(root / 'etc/issue').write_text('NanoKVM OS v1.0.0 beta-11\n')
...
manifest = {
    ...
    'inputs': {'base': 'pristine beta-10 seq23 image',
               'application_commit': '02528afcc2fe0ec192e5b7b45504c765491ec5ae',
