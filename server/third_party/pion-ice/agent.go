...
func (a *Agent) connectivityChecks() { //nolint:cyclop
	...
	for {
		...
		if _, ok := a.net.(PathMTUObserver); ok {
...
func (a *Agent) handleInboundResponse(
	...
	if a.handlePathMTUResponse(msg, local, remoteCandidate, remote, time.Now()) {
		return true
	}
